...
<p align="center">
  <img src="docs/screenshots/campaigns.png" alt="Список кампаний LoreForge" width="49%" />
  <img src="docs/screenshots/dashboard.png" alt="Игровой стол LoreForge с картой, чатом и сценой" width="49%" />
</p>

[Другие скриншоты и детали демо](docs/screenshots/README.md).
